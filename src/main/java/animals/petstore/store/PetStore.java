...
public class PetStore
{
    ...
    public void init()
    {
        ...
        this.addPetInventoryItem(new Bird(AnimalType.DOMESTIC, Skin.FEATHERS, Gender.FEMALE, Breed.HAWK,
                new BigDecimal("1200.00"), 1));
        this.addPetInventoryItem(new Bird(AnimalType.WILD, Skin.FEATHERS, Gender.MALE, Breed.SPARROW,
